...
.Description
POST OOBE during a Windows 10 Feature Update, installed via Windows Update, will run $env:SystemDrive\ProgramData\FeatureUpdate\<version>\SetupComplete.cmd. SetupComplete.cmd calls SetupComplete.ps1
